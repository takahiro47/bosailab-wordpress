...
function twentythirteen_setup() {
   ...
   */
  add_editor_style( array( 'dist/css/editor-style.css', 'fonts/genericons.css', twentythirteen_fonts_url() ) );
...
function twentythirteen_scripts_styles() {
  ...
  wp_enqueue_script( 'theme-script', get_template_directory_uri() . '/js/functions.js', array( 'jquery' ), '2013', true );
